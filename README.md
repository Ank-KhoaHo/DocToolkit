...
dotnet test  DocToolkit.sln -c Release      # 312 tests x 2 target frameworks = 624 results
...
tests/                                                  312 tests, including the public-API approval guard, Stream-overload proofs and the air-gap/dependency guards
