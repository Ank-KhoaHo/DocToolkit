...
| Format | Operations |
|---|---|
| **DOCX** (`DocxEditor`) | `AddBookmark`, `AddEndnote`, `AddFootnote`, `AddTableOfContents`, `AddWatermark`, `Create`, `ExtractText`, `FillRows`, `InspectSignatures`, `IsProtected`, `Merge`, `Protect`, `ReadBookmarks`, `ReadMetadata`, `ReadTable`, `RemoveWatermarks`, `ReplaceImage`, `ReplaceText`, `TableCount`, `Unprotect`, `ValidateSignatures`, `WithMetadata` |
...
| **PDF** (`PdfEditor`) | `ExtractImages`, `ExtractPages`, `ExtractText`, `ExtractWords`, `InsertPages`, `Merge`, `PageCount`, `Protect`, `ReadMetadata`, `RemovePages`, `ReorderPages`, `RotatePages`, `Unprotect`, `WithMetadata` |
| **PPTX** (`PresentationEditor`) | `AddChart`, `Create`, `ExtractText`, `InsertSlides`, `InspectSignatures`, `IsProtected`, `Protect`, `ReadMetadata`, `ReadNotes`, `ReadSlide`, `ReadSmartArt`, `RemoveSlides`, `ReorderSlides`, `ReplaceImage`, `ReplaceText`, `SetNotes`, `SlideCount`, `Unprotect`, `ValidateSignatures`, `WithMetadata` |
