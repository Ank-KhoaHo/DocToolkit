...
**Three findings, and every one was measured rather than assumed:** footnotes, tables nested inside
a table cell, and **content controls in a table** — inside a cell, or wrapping a cell or a row. Text
