...
- **No new NuGet package dependencies.** Every new method delegates to a core `DocToolkit` static method that already exists in the referenced `Ank.DocToolkit` version.
